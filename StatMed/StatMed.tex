...
\begin{document}
	...
	High-throughput genomic technologies have been widely used in recent years for understanding of the associations between genes and clinical phenotypes of interest. A large number of datasets of cancer cohorts have been curated with both genomic and clinical information from the patients. The analyses of these data have yielded valuable insights into cancer mechanisms, subtypes prognosis and treatment response. 
